...
export function getPresets(): CompanionPresetDefinitions {
  ...
  presets["status_media1_ip"] = {
    ...
    steps: [
      {
        down: [
          { actionId: "fetchNetworkStatus", options: { interface: "Media1" } },
        ],
        up: [],
      },
    ],
  ...
  presets["status_config1_ip"] = {
    ...
    steps: [
      {
        down: [
          { actionId: "fetchNetworkStatus", options: { interface: "Config1" } },
        ],
        up: [],
      },
    ],
  ...
  presets["status_media2_ip"] = {
    ...
    steps: [
      {
        down: [
          { actionId: "fetchNetworkStatus", options: { interface: "Media2" } },
        ],
        up: [],
      },
    ],
  ...
  presets["action_refresh_network"] = {
    ...
    steps: [
      { down: [{ actionId: "fetchAllNetworkStatus", options: {} }], up: [] },
    ],
    feedbacks: [],
  };
  ...
  presets["control_panel_status"] = {
    ...
    steps: [
      { down: [{ actionId: "toggleControlPanel", options: {} }], up: [] },
    ],
    feedbacks: [
      {
  ...
  presets["control_panel_enable"] = {
    ...
    steps: [
      { down: [{ actionId: "enableControlPanel", options: {} }], up: [] },
    ],
    feedbacks: [
      {
        feedbackId: "controlPanelEnabled",
  ...
  presets["control_panel_disable"] = {
    ...
    steps: [
      { down: [{ actionId: "disableControlPanel", options: {} }], up: [] },
    ],
    feedbacks: [
      {
        feedbackId: "controlPanelEnabled",
